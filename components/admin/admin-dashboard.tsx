...
import {
  ...
  getDropdownOptions,
  adminCreateDropdownOption,
  adminUpdateDropdownOption,
  adminDeleteDropdownOption,
  getPointSettings,
  updatePointSettings,
...
export function AdminDashboard({ currentUser }: AdminDashboardProps) {
  ...
  const { options: userStatusOptions, loading: userStatusLoading } =
    useDropdownOptions("admin_user_status");
  const { options: reportPriorityOptions, loading: reportPriorityLoading } =
    useDropdownOptions("report_priority");
  const { options: reportTypeOptions, loading: reportTypeLoading } =
    useDropdownOptions("report_type");
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage community, users, and content
          </p>
        </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right text-sm">
                        ...
                        <p className="text-muted-foreground">
                          {user.postsCount} posts • {user.articlesCount}{" "}
                          articles
                        </p>
                      </div>
              ...
              <CardContent>
                ...
                <div className="mt-4 space-y-2">
                  <Button
                    ...
                    onClick={async () => {
                      const res = await adminListForumPosts({
                        page: 1,
                        limit: 20,
                  ...
                  <div key={a._id} className="p-3 border rounded">
                    ...
                    <div className="flex gap-2 mt-2">
                      <Button
                        ...
                        size="sm"
                        onClick={async () => {
                          await adminUpdateArticleStatus(a._id, "published");
                        }}
                      >
                        Approve
                      </Button>
                      <Button
                        ...
                        size="sm"
                        onClick={async () => {
                          await adminUpdateArticleStatus(a._id, "archived");
                        }}
                      >
                        Archive
                      </Button>
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          if (!nextLabel) return;
                          const updated = await adminUpdateDropdownOption(
                            c._id,
                            { label: nextLabel }
                          );
                ...
                <div>
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      const created = await adminCreateDropdownOption({
                      ...
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          ...
                          <h4 className="font-semibold">
                            Report against {report.targetUser}
                          </h4>
                          <p className="text-sm text-muted-foreground">
        ...
        <TabsContent value="analytics" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {analyticsRes?.averageSessionTime ?? "0m"}
                </div>
                <p className="text-xs text-muted-foreground">
                  Per user session
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {analyticsRes?.contentGrowth ?? 0 > 0 ? "+" : ""}
                  {analyticsRes?.contentGrowth ?? 0}%
                </div>
                <p className="text-xs text-muted-foreground">
                  Posts this month vs last
                </p>
              </CardContent>
            </Card>
          </div>
